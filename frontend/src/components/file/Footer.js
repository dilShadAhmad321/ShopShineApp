    ...
    <>
      <div className="Footer-sec">
        <div className="end">
          ...
          <div className="foot-content">
            <ul>
              <p id="footer-heading">GROUP COMPANIES</p>
              <li>Myntra</li>
              <li>Amazon</li>
              <li>Flipkart</li>
              <li>Shopsy</li>
          ...
          <div className="foot-content">
            <ul>
              <p id="footer-heading">LEARN MORE</p>
              <li>Privacy</li>
              <li>Security</li>
              <li>FAQ</li>
            </ul>
          ...
          <div className="foot-content">
            <ul>
              <p id="footer-heading">CUSTOMER POLICY</p>
              <li>Payment</li>
              <li>Shipping</li>
              <li>Security</li>
              <li>Privacy</li>
      ...
      <div className="footer-2">
        <div className="foot-icon  text-light">
